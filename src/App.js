  ...
  return (
    <div className="App">
      <header className="header">
        <picture>
          <source className="header__logo" media="(max-width: 767px)" srcset="./images/logo_mobile.svg" />
          <img className="header__logo" src="<%=require('./images/logo.svg')%>" alt="Логотип 'Место'"/>
        </picture>
      </header>
